...
const PortalApplications = () => {
  return (
    <motion.div className="space-y-6" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }}>
      <div>
        <h1 className="font-display text-2xl font-bold text-foreground tracking-tight">الطلبات الواردة</h1>
      ...
      <Card className="border-border/60 shadow-card">
        <CardContent className="flex flex-col items-center justify-center py-20 text-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-accent/8 mb-5">
            <FileText className="h-7 w-7 text-accent/50" />
          </div>
          <h3 className="font-display text-lg font-bold text-foreground">لا توجد طلبات بعد</h3>
